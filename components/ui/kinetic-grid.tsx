...
// ─── Component ────────────────────────────────────────────────────────────────
// Note: unlike the original full-viewport version, this build scopes the canvas
// and pointer tracking to its own wrapper element (via ResizeObserver + a local
// bounding rect), so it can be dropped in as the background of a single section
// — e.g. just the hero — instead of taking over the whole page.
